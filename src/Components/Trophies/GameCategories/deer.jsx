   ...
   function selectShowingCase(){
    ...
    return (
       ...
       <Card id="topTrophiesCard" onClick={handleClick}>
             <img id="topTrophies" src={"http://127.0.0.1:8000"+props.topBucks.image}></img>  

               <Card id="topTrophiesDetailsCard" > {props.topBucks.weight} lbs; rack_points {props.topBucks.rackpoints}</Card>
        </Card>
