   ...
   function selectShowingCase(){
    ...
    return (
       ...
       <Card id="topTrophiesCard" onClick={handleClick}>
             <img id="topTrophies" src={"http://127.0.0.1:8000"+props.topBass.image}></img>  

               <Card id="topTrophiesDetailsCard" > {props.topBass.weight} lbs</Card>
        </Card>
